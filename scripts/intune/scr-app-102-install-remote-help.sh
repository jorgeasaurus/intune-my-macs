...
## - Detailed logging written to /Library/Logs/Microsoft/IntuneScripts/installRemoteHelp/Remote Help.log
##
## Inputs (variables)
## - weburl: Download URL for the Remote Help PKG
## - mauurl: Download URL for the Microsoft Auto Update PKG
## - appname, app, processpath, terminateprocess, autoUpdate
##
## Artifacts (outputs)
## - Log: /Library/Logs/Microsoft/IntuneScripts/installRemoteHelp/Remote Help.log
## - Meta: /Library/Logs/Microsoft/IntuneScripts/installRemoteHelp/Remote Help.meta (Last-Modified)
##
## Requirements
## - macOS 11 or later
## - Root privileges
...
processpath="/Applications/Remote Help.app/Contents/MacOS/Remote Help"          # The process name of the App we are installing
